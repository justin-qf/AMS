...
class _profileState extends State<profile> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _isDarkMode = getStorage.read(GetStorageKey.IS_DARK_MODE) ?? 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Column(
        children: [
          Container(
              margin: EdgeInsets.only(top: 4.h, right: 3.5.h),
              child: Center(
                  child: Column(
                children: [
                  HomeAppBar(
          ...
          Container(
            child: CupertinoSwitch(
              ...
              onChanged: (value) async {
                ...
                await getStorage.write(GetStorageKey.IS_DARK_MODE, _isDarkMode);
                Get.find<ThemeController>().updateState(_isDarkMode);
                Get.find<ThemeController>().update();
                print(getStorage.read(GetStorageKey.IS_DARK_MODE));
                setState(
                  () {},
                );
              },
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.only(
                          top: 5.h, left: 8.w, right: 8.w, bottom: 15.h),
                      child: Container(
